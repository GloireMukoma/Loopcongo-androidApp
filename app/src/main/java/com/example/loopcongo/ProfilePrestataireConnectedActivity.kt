...
class ProfilePrestataireConnectedActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_profile_prestataire_connected)
        ...
        ApiClient.instance.getPrestataireById(id).enqueue(object : Callback<PrestataireResponse> {
            override fun onResponse(call: Call<PrestataireResponse>, response: Response<PrestataireResponse>) {
                if (response.isSuccessful && response.body()?.status == true) {
                    ...
                    Toast.makeText(this@ProfilePrestataireConnectedActivity, "Erreur récupération prestataire", Toast.LENGTH_SHORT).show()
                }
            }

            override fun onFailure(call: Call<PrestataireResponse>, t: Throwable) {
                Toast.makeText(this@ProfilePrestataireConnectedActivity, "Erreur réseau: ${t.message}", Toast.LENGTH_SHORT).show()
            }
        })
    }
