...
class ProfilVendeursOngletAnnonceFragment : Fragment() {

    private lateinit var recyclerView: RecyclerView
    private lateinit var articleAdapter: OngletAnnonceForProfileVendeurAdapter
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.profil_vendeurs_onglet_annonce, container, false)

        recyclerView = view.findViewById(R.id.profileVendeurOngletAnnonceRecyclerView)
    ...
    companion object {
        ...
        fun newInstance(vendeurId: Int): ProfilVendeursOngletAnnonceFragment {
            val fragment = ProfilVendeursOngletAnnonceFragment()
            val args = Bundle()
