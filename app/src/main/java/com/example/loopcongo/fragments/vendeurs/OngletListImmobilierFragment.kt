...
class OngletListImmobilierFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.onglet_list_immobilier, container, false)
        recyclerView = view.findViewById(R.id.listImmoRecyclerView)
