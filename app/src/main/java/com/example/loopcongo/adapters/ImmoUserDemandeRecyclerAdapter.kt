...
class ImmoUserDemandeRecyclerAdapter(
    ...
    override fun onBindViewHolder(holder: DemandeViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            val msg = "Bonjour, concernant votre demande immobilière sur LoopCongo, nous avons trouvé une solution pour vous.\n\n" +
                    "Votre demande : ${demande.message}"

            val url = "https://wa.me/$contactCustomer?text=${Uri.encode(msg)}"
